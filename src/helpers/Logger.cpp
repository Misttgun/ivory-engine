...
{
	std::string output = "LOG: [" + GetCurrentDateTimeToString() + "]: " + message;
...
{
	std::string output = "WRN: [" + GetCurrentDateTimeToString() + "]: " + message;
...
{
	std::string output = "ERR: [" + GetCurrentDateTimeToString() + "]: " + message;
