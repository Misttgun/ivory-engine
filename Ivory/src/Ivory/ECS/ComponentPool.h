...
namespace Ivory
{
	...
	public:
		...
		{
			SDL_assert(m_entityIdToIndex.find(entity) == m_entityIdToIndex.end() && "Component added to same entity more than once.");
		...
		{
			SDL_assert(m_entityIdToIndex.find(entity) != m_entityIdToIndex.end() && "Removing non-existent component.");
		...
		{
			SDL_assert(m_entityIdToIndex.find(entity) != m_entityIdToIndex.end() && "Retrieving non-existent component.");
		...
		{
			if (m_entityIdToIndex.find(entity) == m_entityIdToIndex.end())
				return;
